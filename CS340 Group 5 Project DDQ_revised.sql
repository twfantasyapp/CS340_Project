...
CREATE TABLE prj_PlayerPosition (
   ...
   CONSTRAINT prj_PlayerPosition_fk1 FOREIGN KEY (playerID) REFERENCES prj_Player (id)ON DELETE CASCADE ON UPDATE CASCADE,
   CONSTRAINT prj_PlayerPosition_fk2 FOREIGN KEY (positionID) REFERENCES prj_Position (id)ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB;
